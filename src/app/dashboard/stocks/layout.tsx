...
const stylePane =
  "relative bg-black sm:border border-neutral-800 sm:rounded-2xl h-screen shadow-xl p-4 overflow-scroll scrollbar-hide pb-64 sm:pb-40 transition-transform transform-gpu overscroll-contain";
